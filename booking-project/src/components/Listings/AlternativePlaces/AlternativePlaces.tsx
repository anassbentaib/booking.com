...
const AlternativePlaces = () => {
  ...
  const {
    ...
    defaultValues: {
      ...
      kingBed: 1,
      twinBed: 1,
      category: alternativeItems?.[0]?.title,
...
export default AlternativePlaces;
